  ...
  return (
    <section>
      <form className="flex pt-26">
        <div className="mx-16 flex w-full justify-center">
          {/* category */}
          <div className="jusify-center relative flex items-center gap-x-2 rounded-l-lg border border-gray-400 px-6 py-3">
            <svg
          ...
          <input
            className="border border-gray-400 ps-4 pe-8 focus:outline-none"
            type="search"
            placeholder="name, description ..."
            onChange={(e) => setQuery(e.currentTarget.value)}
          />

          <div className="jusify-center flex items-center gap-x-2 rounded-e-lg border border-gray-400 px-6 py-3">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              fill="none"
              viewBox="0 0 24 24"
