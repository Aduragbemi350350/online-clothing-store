    ...
    <>
      <section className="bg-white py-8 antialiased lg:py-16 dark:bg-gray-900">
        <div className="mx-auto max-w-2xl px-4">
          ...
          <article className="mb-3 ml-6 rounded-lg bg-white p-6 text-base lg:ml-12 dark:bg-gray-900">
            <footer className="mb-2 flex items-center justify-between">
              <div className="flex items-center">
                <p className="mr-3 inline-flex items-center text-sm font-semibold text-gray-900 dark:text-white">
                  <img
              ...
              <button
                ...
                className="dark:text-gray-40 inline-flex items-center rounded-lg bg-white p-2 text-center text-sm font-medium text-gray-500 hover:bg-gray-100 focus:ring-4 focus:ring-gray-50 focus:outline-none dark:bg-gray-900 dark:hover:bg-gray-700 dark:focus:ring-gray-600"
                type="button"
              >
                <svg
                  className="h-4 w-4"
